...
(function() {
  ...
  var template = '<div class="vue-input" :class="[message ? \'has-message\' : \'\', disabled ? \'disabled\' : \'\', type]">\
                    ...
                    <input :disabled="disabled" id="{{ id}}" type="text" name="{{ name }}" maxlength="{{ maxlength }}" v-if="showInputFor(\'string\')" v-on:keyup.enter="inputChange()" :placeholder="placeholder" v-el:input>\
